...
import ssm.dao.RedPacketDao;
import ssm.dao.UserRedPacketDao;
import ssm.pojo.RedPacket;
import ssm.pojo.UserRedPacket;
import ssm.service.RedisRedPacketService;
import ssm.service.UserRedPacketService;
import org.apache.log4j.Logger;

@Service
public class UserRedPacketServiceImpl implements UserRedPacketService {
	private static Logger logger = Logger.getLogger(UserRedPacketServiceImpl.class);
	...
	public int grapRedPacket(Long redPacketId, Long userId) {
		...
		if (redPacket.getStock() > 0) {
			...
			System.out.println(userId+"  —false—  "+redPacketDao.getRedPacket(redPacketId).getStock());
			return result;
		}
		// 失败返回
		return FAILED;
